...
from sigil import _, api, fields, models, Command, tools
from sigil.exceptions import UserError, ValidationError
from sigil.fields import Domain
from sigil.tools.mail import is_html_empty, email_normalize, email_split_and_format
from sigil.tools.misc import clean_context
from sigil.addons.mail.tools.parser import parse_res_ids
...
class MailComposeMessage(models.TransientModel):
    ...
    auto_delete = fields.Boolean(
        ...
        help='This option permanently removes any track of email after it\'s been sent, including from the Technical menu in the Settings, in order to preserve storage space of your Sigil database.')
    ...
    def _evaluate_res_domain(self):
        ...
        :return: an Sigil domain (list of leaves) """
        self.ensure_one()
