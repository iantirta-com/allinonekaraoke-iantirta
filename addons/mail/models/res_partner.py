...
from sigil.tools.misc import limited_field_access_token
...
class ResPartner(models.Model):
    ...
    def _compute_im_status(self):
        ...
        sigilbot_id = self.env['ir.model.data']._xmlid_to_res_id('base.partner_root')
        sigilbot = self.env['res.partner'].browse(sigilbot_id)
        if sigilbot in self:
            sigilbot.im_status = 'bot'
