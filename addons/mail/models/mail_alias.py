...
from sigil.tools import is_html_empty, remove_accents
...
class MailAlias(models.Model):
    """A Mail Alias is a mapping of an email address with a given Sigil Document
       model. It is used by Sigil's mail gateway when processing incoming emails
       ...
       created, it becomes immediately usable and Sigil will accept email for it.
     """
    _name = 'mail.alias'
    ...
    alias_name = fields.Char(
        ...
        help="The name of the email alias, e.g. 'jobs' if you want to catch emails for <jobs@example.iantirta.com>")
    ...
    alias_model_id = fields.Many2one('ir.model', 'Aliased Model', required=True, ondelete="cascade",
                                     help="The model (Sigil Document Kind) to which this alias "
    ...
    def _compute_display_name(self):
        ...
        domain if found otherwise "Inactive Alias". e.g.`jobs@mail.iantirta.com`
