...
from sigil import _, api, Command, fields, models, modules, tools
from sigil.exceptions import UserError
from sigil.http import request
from sigil.tools import email_normalize, str2bool
...
class ResUsers(models.Model):
    ...
    notification_type = fields.Selection([
        ...
        help="Policy on how to handle Chatter notifications:\n"
             ...
             "- In Sigil: notifications appear in your Sigil Inbox")
    ...
    _notification_type = models.Constraint(
        ...
        'Only internal user can receive notifications in Sigil',
    )
    ...
    def _init_store_data(self, store: Store):
        ...
        # sudo: res.partner - exposing SigilBot data is considered acceptable
        sigilbot = self.env.ref("base.partner_root").sudo()
        if not self.env.user._is_public():
            sigilbot = sigilbot.with_prefetch((sigilbot + self.env.user.partner_id).ids)
