...
from sigil import _, api, fields, models, tools, Command
from sigil.addons.base.models.avatar_mixin import get_hsl_from_seed
...
from sigil.addons.mail.tools.web_push import PUSH_NOTIFICATION_TYPE
from sigil.exceptions import AccessError, UserError, ValidationError
from sigil.fields import Domain
from sigil.tools import format_list, email_normalize, html_escape
from sigil.tools.misc import hash_sign, OrderedSet
from sigil.tools.sql import SQL
...
class DiscussChannel(models.Model):
    ...
    def _get_access_action(self, access_uid=None, force_website=False):
        ...
        return {
            "type": "ir.actions.act_url",
            "url": f"/sigil/action-mail.action_discuss?active_id={self.id}",
            "target": "self",
        }
