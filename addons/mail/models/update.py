...
from sigil import api, fields, release, SUPERUSER_ID
from sigil.exceptions import UserError
from sigil.models import AbstractModel
...
class Publisher_WarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to Sigil's publisher warranty server to check the
