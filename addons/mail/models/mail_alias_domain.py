...
from sigil import api, exceptions, fields, models, _
from sigil.addons.mail.models.mail_alias import dot_atom_text
...
class MailAliasDomain(models.Model):
    ...
    name = fields.Char(
        'Name', required=True,
        help="Email domain e.g. 'example.com' in 'sigil@example.com'")
