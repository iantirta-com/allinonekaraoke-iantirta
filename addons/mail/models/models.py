...
from sigil import api, exceptions, models, tools, _
from sigil.addons.mail.tools.alias_error import AliasError
from sigil.tools import parse_contact_from_email
from sigil.tools.mail import email_normalize, email_split_and_format
from sigil.tools.sql import column_exists
...
class Base(models.AbstractModel):
    ...
    def _message_get_default_recipients(self, with_cc=False, all_tos=False):
        ...
        ban_emails = []
        # ban emails: don't propose sigilbot unless another active partner has the same email
    ...
    def _message_get_suggested_recipients_batch(self, reply_discussion=False, reply_message=None,
        ...
        # ban emails: never propose sigilbot nor aliases
    ...
    def _notify_by_email_get_headers(self, headers=None):
        ...
        if not self:
            return headers
        self.ensure_one()
        headers['X-Sigil-Objects'] = f"{self._name}-{self.id}"
