...
import { reactive } from "@sigil/owl";
...
export class Store extends BaseStore {
     ...
     */
    inPublicPage = false;
    sigilbot = fields.One("res.partner");
    ...
    onStarted() {
        this.isSigilWhiteTheme = cookie.get("color_scheme") !== "dark" || this.inPublicPage;
