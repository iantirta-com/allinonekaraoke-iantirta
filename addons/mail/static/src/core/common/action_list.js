...
import { Component, onWillUnmount } from "@sigil/owl";
...
class Action extends Component {
    ...
    get hasBtnBg() {
        return (
            this.props.sigilControlPanelSwitchStyle ||
            this.props.hasBtnBg ||
...
export class ActionList extends Component {
    ...
    get hasBtnBg() {
        return this.props.sigilControlPanelSwitchStyle || this.props.hasBtnBg;
    }
}
