 ...
 * signature:
 *     (partner1: Partner, partner2: Partner, { env: SigilEnv, searchTerm: string, thread?: Thread , context?: Object}) => number|undefined
 */
export const partnerCompareRegistry = registry.category("mail.partner_compare");

partnerCompareRegistry.add(
    "mail.archived-last-except-sigilbot",
    (p1, p2) => {
        const p1active = p1.active || p1.eq(p1.store.sigilbot);
        const p2active = p2.active || p2.eq(p2.store.sigilbot);
