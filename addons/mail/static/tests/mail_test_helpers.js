...
import { hover as hootHover, queryFirst, resize } from "@sigil/hoot-dom";
...
import { Component, onMounted, onPatched, onWillDestroy, status } from "@sigil/owl";
 ...
 *
 * @param {Object} param0
 * @param {Partial<SigilEnv>} param0.env
