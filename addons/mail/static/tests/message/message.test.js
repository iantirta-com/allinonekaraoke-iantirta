...
import { animationFrame, leave, pointerDown, press, queryFirst, waitFor } from "@sigil/hoot-dom";
import { advanceTime, mockDate, mockTouch, mockUserAgent, tick } from "@sigil/hoot-mock";
import {
    asyncStep,
...
test("edit a message with styling keeps the styling", async () => {
    ...
    await click(".o-mail-Message [title='Edit']");
    await contains(".o-mail-Composer-html.sigil-editor-editable strong:contains('Hello world')");
});
...
test("edit a message styling", async () => {
    ...
    await click(".o-mail-Message [title='Edit']");
    await focus(".o-mail-Message .o-mail-Composer-html.sigil-editor-editable");
    const editor = {
        document,
        editable: document.querySelector(
            ".o-mail-Message .o-mail-Composer-html.sigil-editor-editable"
        ),
    };
