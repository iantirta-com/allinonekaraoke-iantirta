...
import { animationFrame, describe, test } from "@sigil/hoot";
import { advanceTime, mockDate } from "@sigil/hoot-mock";
import {
    asyncStep,
    Command,
    getService,
...
test("show typing in member list", async () => {
    ...
    const threadComposerEditor = {
        ...
        editable: document.querySelector(
            ".o-mail-Composer.o-discussApp .o-mail-Composer-html.sigil-editor-editable"
        ),
    };
    ...
    await contains(".o-mail-Message-content:has(:text('HelloWorld!'))");
    await click(".o-mail-Message [title='Edit']");
    await contains(".o-mail-Message .o-mail-Composer-html.sigil-editor-editable");
