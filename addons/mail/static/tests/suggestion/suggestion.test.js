...
test("mention a channel thread", async () => {
    ...
    await contains(
        ".o-mail-Composer-html.sigil-editor-editable a.o_channel_redirect:has(i.fa-hashtag)",
        { text: "General" }
    );
    await press("Enter");
    ...
    await click(".o-mail-Composer-suggestion:eq(1)");
    await contains(
        ".o-mail-Composer-html.sigil-editor-editable a.o_channel_redirect:has(i.fa-comments-o)",
        { text: "General > ThreadOne" }
    );
    await press("Enter");
    await contains(".o-mail-Message a.o_channel_redirect:has(i.fa-comments-o)", {
...
test("Mention with @everyone", async () => {
    ...
    await click(".o-mail-Composer-suggestion");
    await contains(".o-mail-Composer-html.sigil-editor-editable", { text: "@everyone" });
    await press("Enter");
    await contains(".o-mail-Message-bubble.o-orange");
    await contains(".o-mail-Message a:contains('@everyone')");
});
...
test("Mention with @-role", async () => {
    ...
    await click(".o-mail-Composer-suggestion");
    await contains(".o-mail-Composer-html.sigil-editor-editable", { text: "@rd-Discuss" });
    await press("Enter");
    await contains(".o-mail-Message a.o-discuss-mention", {
        text: "@rd-Discuss",
    });
