...
test("composer text input placeholder should contain channel name when thread does not have specific correspondent", async () => {
    ...
    await openDiscuss(channelId);
    await contains(
        ".o-mail-Composer-html.sigil-editor-editable .o-we-hint[o-we-hint-text='Message #General…']"
    );
});
...
test("composer input placeholder in channel thread", async () => {
    ...
    await openDiscuss(subchannelID);
    await contains(
        ".o-mail-Composer-html.sigil-editor-editable .o-we-hint[o-we-hint-text='Message \"ThreadFromGeneral\"']"
    );
});
...
test("add an emoji", async () => {
    ...
    await click("button[title='Add Emojis']");
    await click(".o-Emoji", { text: "😤" });
    await contains(".o-mail-Composer-html.sigil-editor-editable", { text: "😤" });
});
...
test("Exiting emoji picker brings the focus back to the Composer textarea", async () => {
    ...
    composerService.setHtmlComposer();
    await click("button[title='Add Emojis']");
    await contains(".o-mail-Composer-html.sigil-editor-editable:not(:focus)");
    triggerHotkey("Escape");
    await contains(".o-mail-Composer-html.sigil-editor-editable:focus");
});
...
test("add an emoji after some text", async () => {
    ...
    const composerService = getService("mail.composer");
    composerService.setHtmlComposer();
    await focus(".o-mail-Composer-html.sigil-editor-editable");
    const editor = {
        document,
        editable: document.querySelector(".o-mail-Composer-html.sigil-editor-editable"),
    };
    await htmlInsertText(editor, "Blabla");
    await contains(".o-mail-Composer-html.sigil-editor-editable", { text: "Blabla" });
    await click("button[title='Add Emojis']");
    await click(".o-Emoji", { text: "🤑" });
    await contains(".o-mail-Composer-html.sigil-editor-editable", { text: "Blabla🤑" });
});
...
test("composer text input placeholder should contain correspondent name when thread has exactly one correspondent", async () => {
    ...
    composerService.setHtmlComposer();
    await contains(
        ".o-mail-Composer-html.sigil-editor-editable .o-we-hint[o-we-hint-text='Message Marc Demo…']"
    );
});
...
test("composer: paste attachments", async () => {
    ...
    await contains(".o-mail-AttachmentList .o-mail-AttachmentContainer", { count: 0 });
    await pasteFiles(".o-mail-Composer-html.sigil-editor-editable", [text]);
    await contains(
        ".o-mail-AttachmentList .o-mail-AttachmentContainer:not(.o-isUploading):contains(text.txt)"
    );
});
...
test("select a canned response suggestion", async () => {
    ...
    await htmlInsertText(editor, "::");
    await click(".o-mail-Composer-suggestion");
    await contains(".o-mail-Composer-html.sigil-editor-editable", { text: "Hello! How are you?" });
});
...
test("select a canned response suggestion with some text", async () => {
    ...
    await contains(".o-mail-Composer-html.sigil-editor-editable", { text: "bluhbluh" });
    await htmlInsertText(editor, "::");
    await click(".o-mail-Composer-suggestion");
    await contains(".o-mail-Composer-html.sigil-editor-editable", {
...
test("html composer: basic rendering", async () => {
    ...
    await contains(".o-mail-Composer-html.sigil-editor-editable", { text: "Hello World!" });
    await focus(".o-mail-Composer-html.sigil-editor-editable");
    const editor = {
        document,
        editable: document.querySelector(".o-mail-Composer-html.sigil-editor-editable"),
...
test("mention insertion adds FEFF markers for safe cursor placement", async () => {
    ...
    await contains(".o-mail-Composer-html.sigil-editor-editable:text('@Mitchell Admin')");
...
test("mentions can be correctly selected with ctrl+A and deleted", async () => {
    ...
    await htmlInsertText(editor, "Hello");
    await contains(".o-mail-Composer-html.sigil-editor-editable:text('@Mitchell Admin Hello')");
    ...
    await htmlInsertText(editor, "Hello");
    await contains(".o-mail-Composer-html.sigil-editor-editable:text('General Hello')");
    await focus(editor.editable);
    await press("Control+a");
    await press("Backspace");
    ...
    await contains(
        ".o-mail-Composer-html.sigil-editor-editable:text('Hello @Mitchell Admin nice to meet you!')"
    );
    await focus(editor.editable);
    await press("Control+a");
    await press("Backspace");
    ...
    await contains(editor.editable.querySelector("i.fa-hashtag"));
    await htmlInsertText(editor, "nice to meet you!");
    await contains(".o-mail-Composer-html.sigil-editor-editable:text('Hello General nice to meet you!')");
    await focus(editor.editable);
    await press("Control+a");
    await press("Backspace");
    await contains(editor.editable.querySelector("i.fa-hashtag"), { count: 0 });
...
test("mentions can be correctly cut with ctrl+A and ctrl+X", async () => {
    ...
    await htmlInsertText(editor, "#general");
    await click(".o-mail-NavigableList-item:text('General')");
    await contains(".o-mail-Composer-html.sigil-editor-editable:text('General')");
    await contains(editor.editable.querySelector("i.fa-hashtag"));
    await htmlInsertText(editor, "Hello");
    await contains(".o-mail-Composer-html.sigil-editor-editable:text('General Hello')");
    await focus(editor.editable);
    ...
    await htmlInsertText(editor, "Hello @admin");
    await click(".o-mail-NavigableList-item:text('Mitchell Admin')");
    await contains(".o-mail-Composer-html.sigil-editor-editable:text('Hello @Mitchell Admin')");
    await htmlInsertText(editor, "nice to meet you!");
    await contains(
        ".o-mail-Composer-html.sigil-editor-editable:text('Hello @Mitchell Admin nice to meet you!')"
    );
    ...
    await htmlInsertText(editor, "Hello #general");
    await click(".o-mail-NavigableList-item:text('General')");
    await contains(".o-mail-Composer-html.sigil-editor-editable:text('Hello General')");
    await contains(editor.editable.querySelector("i.fa-hashtag"));
    await htmlInsertText(editor, "nice to meet you!");
    await contains(
        ".o-mail-Composer-html.sigil-editor-editable:text('Hello General nice to meet you!')"
    );
    await focus(editor.editable);
    await press("Control+a");
    cut(editor);
