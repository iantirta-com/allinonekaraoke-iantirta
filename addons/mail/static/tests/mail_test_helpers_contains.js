/** @sigil-module alias=@web/../tests/utils default=false */

import { __debug__, after, afterEach, expect, getFixture } from "@sigil/hoot";
import { queryAll, queryFirst } from "@sigil/hoot-dom";
 ...
 *
 * @param {import("@sigil/hoot-dom").Target} selector
 ...
 *  element.
 * @property {HTMLElement|SigilEnv} [target=getFixture()]
...
class Contains {
    ...
    constructor(selector, options = {}) {
        ...
        if (this.options.target?.testEnv) {
            // when SigilEnv, special key `target`. See @start
