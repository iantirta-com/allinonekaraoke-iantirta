...
registry.category("web_tour.tours").add("can_create_channel_from_form_view", {
    steps: () => [
        {
            trigger: ".o-mail-DiscussSidebarChannel-itemName:contains(SigilBot)",
            run: "click",
        },
        {
            trigger: ".o-mail-DiscussContent-threadName[title='SigilBot']",
        },
        ...
        {
            trigger: ".breadcrumb-item:contains('SigilBot')",
            run: "click",
        },
        {
