...
registry.category("web_tour.tours").add("mail_template_dynamic_placeholder_tour", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger: ".note-editable.sigil-editor-editable",
            async run(actions) {
        ...
        },
        {
            ...
            trigger: `.note-editable.sigil-editor-editable t[t-out="object.company_name"]:contains("defValue")`,
        },
        {
        ...
        {
            content: "Ensure the editable contain the dynamic placeholder t tag",
            trigger: `.note-editable.sigil-editor-editable t[t-out="format_datetime(object.create_date, tz=object.partner_id.tz) or 'localTime'"]:contains("localTime")`,
        },
        {
