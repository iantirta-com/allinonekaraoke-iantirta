...
import { after, before, beforeEach, expect, test } from "@sigil/hoot";
import { press, queryOne } from "@sigil/hoot-dom";
import { animationFrame, enableTransitions } from "@sigil/hoot-mock";
import {
    clickSave,
    contains,
    defineModels,
...
test("HtmlMail save inline html", async function () {
    ...
    await press("enter");
    expect(".sigil-editor-editable").toHaveInnerHTML("<h1> first </h1>");
