...
from sigil import _, http
from sigil.exceptions import AccessError
from sigil.http import STATIC_CACHE, Response, request
from sigil.tools import consteq
...
class MailController(http.Controller):
    ...
    def _redirect_to_messaging(cls):
        url = '/sigil/action-mail.action_discuss'
    ...
    def _redirect_to_record(cls, model, res_id, access_token=None, **kwargs):
        ...
        url = f'/sigil/{model_in_url}/{res_id}?{url_encode(url_params, sort=True)}'
        return request.redirect(url)
    ...
    def export_icon_to_png(self, icon, color='#000', bg=None, size=100, alpha=255, font='/web/static/src/libs/fontawesome/fonts/fontawesome-webfont.ttf', width=None, height=None):
        ...
        if icon.isdigit():
            ...
            if icon in oi_font_char_codes:
                ...
                font = "/web/static/lib/sigil_ui_icons/fonts/sigil_ui_icons.woff"
