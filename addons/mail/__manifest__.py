...
Communicate with your colleagues/customers/guest within Sigil.
...
from Sigil itself, and that too with great possibilities. For example,
...
mailbox-to-Sigil integration. Even better: these documents directly act as mini
conversations synchronized by email. You can reply from within Sigil, and the
...
(technically: Server Actions) to be triggered for each incoming mail.
    ...
    'assets': {
        ...
        'mail.assets_sigil_sfu': [
            'mail/static/lib/sigil_sfu/sigil_sfu.js',
        ],
        'mail.assets_lamejs': [
            'mail/static/lib/lame/lame.js',
        ],
        "mail.assets_message_email": [
            "web/static/lib/sigil_ui_icons/style.css",
        ],
        'mail.assets_public': [
