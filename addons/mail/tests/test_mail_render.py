...
from sigil.addons.mail.tests import common
from sigil.exceptions import AccessError
from sigil.tests import Form, tagged, users
...
class TestMailRender(TestMailRenderCommon):
    ...
    def test_render_template_inline_template_w_post_process_custom_local_links(self):
        ...
        with patch('sigil.models.Model.get_base_url', new=_mock_get_base_url), self.assertQueryCount(13):
...
class TestMailRenderSecurity(TestMailRenderCommon):
    ...
    def test_render_restricted_allow_template_defaults(self):
        ...
        with patch(
            'sigil.addons.base.models.res_partner.ResPartner._mail_template_default_values',
