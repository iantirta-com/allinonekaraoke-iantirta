...
from sigil.addons.base.tests.common import HttpCase
from sigil.addons.mail.tests.common import mail_new_test_user, MailCommon
from sigil.http import Request
from sigil.tests import JsonRpcException
from sigil.tools import file_open, mute_logger
...
class MailControllerAttachmentCommon(MailControllerCommon):
    ...
    def _upload_attachment(self, document, route_kw):
        ...
        with mute_logger("sigil.http"), file_open("addons/web/__init__.py") as file:
            res = self.url_open(
