...
from sigil.addons.base.models.res_users import ResUsersPatchedInTest
...
from sigil.tests import RecordCapturer, tagged, users
...
class TestUser(MailCommon):
    ...
    def test_notification_type_constraint(self):
        with self.assertRaises(IntegrityError, msg='Portal user can not receive notification in Sigil'):
            mail_new_test_user(
                self.env,
