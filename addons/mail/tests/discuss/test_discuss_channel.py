...
from sigil import Command, fields
from sigil.addons.bus.models.bus import json_dump
from sigil.addons.mail.models.discuss.discuss_channel import channel_avatar, group_avatar
from sigil.addons.mail.tests.common import mail_new_test_user
from sigil.addons.mail.tests.common import MailCommon
from sigil.addons.mail.tools.discuss import Store
from sigil.exceptions import ValidationError
from sigil.tests import HttpCase, tagged, users
from sigil.tools import html_escape, mute_logger
...
class TestChannelInternals(MailCommon, HttpCase):
    ...
    @users('employee')
    @mute_logger('sigil.addons.mail.models.mail_mail', 'sigil.models.unlink')
