...
from sigil.addons.base.tests.common import HttpCaseWithUserDemo, new_test_user
...
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_mail_tour(self):
        self.start_tour("/sigil", 'discuss_channel_tour', login="admin")
    ...
    def test_02_mail_create_channel_no_mail_tour(self):
        ...
        self.start_tour("/sigil", 'discuss_channel_tour', login='testuser')

    # basic rendering test of the configuration menu in Discuss
    def test_03_mail_discuss_configuration_tour(self):
        self.start_tour("/sigil", "discuss_configuration_tour", login="admin")
    ...
    def test_04_meeting_view_tour(self):
        ...
        self.start_tour(
            f"/sigil/discuss?active_id=discuss.channel_{group_chat.id}&fullscreen=1",
    ...
    def test_05_can_create_channel_tour(self):
        self.start_tour("sigil/discuss", "can_create_channel_from_form_view", login="demo")
