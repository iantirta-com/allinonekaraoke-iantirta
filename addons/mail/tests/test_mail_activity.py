...
from sigil import exceptions
from sigil.addons.mail.tests.common_activity import ActivityScheduleCase
from sigil.tests import tagged, HttpCase
...
class TestMailActivityChatter(HttpCase):
    ...
    def test_mail_activity_schedule_from_chatter(self):
        self.start_tour(
            f"/sigil/res.partner/{self.test_partner.id}",
