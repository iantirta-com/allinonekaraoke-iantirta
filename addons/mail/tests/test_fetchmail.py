...
from sigil.tests import TransactionCase, mute_logger
...
class TestFetchmail(TransactionCase):
    ...
    def test_fetchmail_deactivation(self):
        ...
        with (
            ...
            mute_logger('sigil.addons.mail.models'),
            self.assertLogs('sigil.addons.base.models.ir_cron') as cron_log_catcher,
        ):
            ...
            self.assertIn('WARNING:sigil.addons.base.models.ir_cron:Deactivating fetchmail imap server test deactivation server (too many failures)', cron_log_catcher.output)
