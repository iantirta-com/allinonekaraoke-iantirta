...
class MailCase(TransactionCase):
    ...
    def test_mail_send_non_connected_smtp_session(self):
        ...
        with mock.patch("sigil.addons.base.models.ir_mail_server.IrMail_Server._connect__", return_value=disconnected_smtpsession):
            with mock.patch("sigil.addons.mail.models.mail_mail._logger.info") as mock_logging_info:
                mail.send()
