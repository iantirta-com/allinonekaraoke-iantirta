...
seamless communication in Sigil Discuss without any constraints.

> Please note that this extension only works for Sigil 17 and higher and is not
...
- Command scope must be set to `global`. You can click the extension icon to get
  ...
  directly.
- Push-to-Talk should be enabled on Sigil Discuss voice settings.
