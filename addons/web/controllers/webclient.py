...
class WebClient(http.Controller):
    ...
    def bootstrap_translations(self, mods=None):
        ...
        if mods is None:
            mods = sigil.tools.config['server_wide_modules']
            if request.db:
    ...
    def translations(self, hash=None, mods=None, lang=None):
        ...
        if mods:
            ...
            mods = request.env.registry._init_modules.union(sigil.tools.config['server_wide_modules'])
    ...
    def version_info(self):
        return sigil.service.common.exp_version()
