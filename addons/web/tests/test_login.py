...
from sigil.tests.common import get_db_name, HOST, HttpCase, new_test_user, Opener, tagged
...
class TestWebLogin(TestWebLoginCommon):
    def test_web_login(self):
        ...
        self.assertEqual(res_post.request.path_url, '/sigil')
...
class TestUserSwitch(HttpCaseWithUserDemo):
    def test_user_switch(self):
        self.start_tour('/sigil', 'test_user_switch', login='demo')
