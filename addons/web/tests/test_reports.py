...
from sigil.addons.http_routing.tests.common import MockRequest
from sigil.exceptions import UserError
from sigil.http import root
from sigil.tools import mute_logger


class TestReports(sigil.tests.HttpCase):
    def test_report_session_cookie(self):
        """ Asserts wkhtmltopdf forwards the user session when requesting resources to Sigil, such as images,
    ...
    @mute_logger('sigil.addons.base.models.ir_actions_report')
