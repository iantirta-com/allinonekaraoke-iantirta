/** @sigil-module alias=@web/../tests/qunit default=false */
...
import { Component, whenReady } from "@sigil/owl";
...
export function setupQUnit() {
    ...
    QUnit.done(async (result) => {
        await sigil.loader.checkErrorProm;
    ...
    QUnit.begin(function () {
        if (sigil.debug && sigil.debug.includes("assets")) {
    ...
    QUnit.on("SigilAfterTestHook", (info) => {
