/** @sigil-module alias=@web/../tests/setup default=false */
...
import { App, EventBus, whenReady } from "@sigil/owl";
...
function makeMockLocation() {
    return Object.assign(document.createElement("a"), {
        href: window.location.origin + "/sigil",
        assign(url) {
            this.href = url;
        },
        reload() {},
