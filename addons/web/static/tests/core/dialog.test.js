import { destroy, expect, mockTouch, test } from "@sigil/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne, resize } from "@sigil/hoot-dom";
import { animationFrame } from "@sigil/hoot-mock";
import { Component, onMounted, useState, xml } from "@sigil/owl";
import {
    contains,
    getService,
    makeDialogMockEnv,
