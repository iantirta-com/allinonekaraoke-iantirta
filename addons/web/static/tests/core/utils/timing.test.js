import { describe, destroy, expect, getFixture, test } from "@sigil/hoot";
import { click, tick } from "@sigil/hoot-dom";
import { Deferred, advanceTime, animationFrame, microTick, runAllTimers } from "@sigil/hoot-mock";
