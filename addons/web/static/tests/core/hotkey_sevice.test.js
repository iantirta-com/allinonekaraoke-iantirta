import { destroy, expect, getFixture, onError, test } from "@sigil/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne } from "@sigil/hoot-dom";
import { animationFrame, mockUserAgent, tick } from "@sigil/hoot-mock";
import { Component, useRef, useState, xml } from "@sigil/owl";
import {
    contains,
    getService,
    makeMockEnv,
