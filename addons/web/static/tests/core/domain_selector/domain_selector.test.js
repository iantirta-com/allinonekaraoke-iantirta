import { expect, test, getFixture } from "@sigil/hoot";
import { press, queryAll, queryAllAttributes, queryAllTexts, queryOne } from "@sigil/hoot-dom";
import { animationFrame, mockDate, mockTimeZone, runAllTimers } from "@sigil/hoot-mock";
