/** @sigil-module alias=@web/../tests/mobile/core/action_swiper_tests default=false */

import { beforeEach, expect, test } from "@sigil/hoot";
import { hover, queryFirst } from "@sigil/hoot-dom";
import { advanceTime, animationFrame, mockTouch } from "@sigil/hoot-mock";
import { Component, onPatched, xml } from "@sigil/owl";
import {
    contains,
    defineParams,
    mountWithCleanup,
