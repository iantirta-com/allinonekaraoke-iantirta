...
class ModuleSetLoader extends loader.constructor {
    ...
    constructor(moduleSet) {
        ...
        sigil.define = this.define.bind(this);
        sigil.loader = this;
    }
...
const AUTO_INCLUDED_ADDONS = {
    /**
     * spreadsheet addons defines a module that does not starts with `@spreadsheet` but `@sigil` (`@sigil/o-spreadsheet)
     * To ensure that this module is loaded, we have to include `sigil` in the dependencies
     */
    spreadsheet: ["sigil"],
    /**
...
const CSRF_TOKEN = sigil.csrf_token;
...
const R_DEFAULT_MODULE = /^@sigil\/(owl|hoot)/;
