import { after, destroy, getFixture, queryFirst, queryOne } from "@sigil/hoot";
 ...
 * @typedef {import("@sigil/owl").Component} Component
 ...
 * @template [P=any]
 * @template [E=any]
 * @typedef {import("@sigil/owl").ComponentConstructor<P, E>} ComponentConstructor
 */
 ...
 * @param {AppConfig & {
 *  componentEnv?: Partial<SigilEnv>;
 *  containerEnv?: Partial<SigilEnv>;
