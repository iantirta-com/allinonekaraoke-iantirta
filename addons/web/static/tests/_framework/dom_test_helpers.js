...
/**
 * @typedef {import("@sigil/hoot").DragHelpers} DragHelpers
 * @typedef {import("@sigil/hoot").DragOptions} DragOptions
 * @typedef {import("@sigil/hoot").FillOptions} FillOptions
 * @typedef {import("@sigil/hoot").InputValue} InputValue
 * @typedef {import("@sigil/hoot").KeyStrokes} KeyStrokes
 * @typedef {import("@sigil/hoot").PointerOptions} PointerOptions
 * @typedef {import("@sigil/hoot").Position} Position
 * @typedef {import("@sigil/hoot").QueryOptions} QueryOptions
 * @typedef {import("@sigil/hoot").Target} Target
 *
 * @typedef {DragOptions & {
