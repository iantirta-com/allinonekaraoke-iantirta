...
import { after, before, beforeEach, createJobScopedGetter } from "@sigil/hoot";
import { validateType } from "@sigil/owl";

const { view_info } = sigil.__session_info__ || {};
delete sigil.__session_info__;
