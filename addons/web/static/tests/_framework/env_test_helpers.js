import { after, afterEach, beforeEach, registerDebugInfo } from "@sigil/hoot";
 ...
 *
 * @param {Partial<SigilEnv>} [partialEnv]
 * @param {{
 *  makeNew?: boolean;
 * }} [options]
 */
 ...
 *  (env: SigilEnv, dependencies: Dependencies) => Services[T]
 * } serviceFactory
 */
