import { getFixture, after } from "@sigil/hoot";
...
export async function startInteractions(
    ...
    if (sigil.loader.modules.has("@mail/../tests/mail_test_helpers")) {
        const { defineMailModels } = sigil.loader.modules.get("@mail/../tests/mail_test_helpers");
        defineMailModels();
    }
