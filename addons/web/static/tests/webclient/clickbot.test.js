...
import { animationFrame, Deferred, mockDate, runAllTimers, tick } from "@sigil/hoot-mock";
import {
    defineActions,
    defineMenus,
    defineModels,
...
import { onWillStart, onWillUpdateProps } from "@sigil/owl";
...
test("clickbot show rpc error when an error dialog is detected", async () => {
    ...
    const expectedRpcData = JSON.stringify({
        ...
        error: {
            ...
            code: 0,
            data: {
                name: "sigil.exceptions.Programming error",
                debug: "traceback",
                arguments: [],
                context: {},
                message: "This is a server Error, it should be displayed in an error dialog",
            },
            exceptionName: "sigil.exceptions.Programming error",
            subType: "server",
            message: "This is a server Error, it should be displayed in an error dialog",
            model: "foo",
