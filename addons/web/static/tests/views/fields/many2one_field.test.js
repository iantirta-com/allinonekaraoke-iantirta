...
test("many2one in non edit mode (with value)", async () => {
    ...
    expect("div[name=res_trululu] a.o_form_uri").toHaveAttribute("href", "/sigil/res.partner/1");
    expect("div[name=trululu] a.o_form_uri").toHaveAttribute("href", "/sigil/m-partner/4");
});
