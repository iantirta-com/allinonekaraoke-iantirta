...
(function (sigil) {
    ...
    class ModuleLoader {
        /** @type {SigilModuleLoader["bus"]} */
        bus = new EventTarget();
        /** @type {SigilModuleLoader["checkErrorProm"]} */
        checkErrorProm = null;
        /** @type {SigilModuleLoader["factories"]} */
        factories = new Map();
        /** @type {SigilModuleLoader["failed"]} */
        failed = new Set();
        /** @type {SigilModuleLoader["jobs"]} */
        jobs = new Set();
        /** @type {SigilModuleLoader["modules"]} */
        modules = new Map();
        ...
        /** @type {SigilModuleLoader["addJob"]} */
        addJob(name) {
            this.jobs.add(name);
            this.startModules();
        }

        /** @type {SigilModuleLoader["define"]} */
        define(name, deps, factory, lazy = false) {
            ...
            this.factories.set(name, {
                deps,
                fn: factory,
                ignoreMissingDeps: globalThis.__sigilIgnoreMissingDependencies,
            });
            if (!lazy) {
                this.addJob(name);
        ...
        /** @type {SigilModuleLoader["findErrors"]} */
        ...
        /** @type {SigilModuleLoader["findJob"]} */
        findJob() {
        ...
        /** @type {SigilModuleLoader["reportErrors"]} */
        ...
        /** @type {SigilModuleLoader["startModules"]} */
        startModules() {
            let job;
        ...
        /** @type {SigilModuleLoader["startModule"]} */
        startModule(name) {
            /** @type {(dependency: string) => SigilModule} */
            const require = (dependency) => this.modules.get(dependency);
            this.jobs.delete(name);
            const factory = this.factories.get(name);
            /** @type {SigilModule | null} */
            let module = null;
            try {
    ...
    sigil.define = loader.define.bind(loader);
    sigil.loader = loader;

    if (sigil.debug && !loader.debug) {
