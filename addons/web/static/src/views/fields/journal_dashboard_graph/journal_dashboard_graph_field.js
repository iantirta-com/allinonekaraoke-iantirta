...
import { Component, onWillStart, useEffect, useRef } from "@sigil/owl";
...
export class JournalDashboardGraphField extends Component {
    ...
    getLineChartConfig() {
        ...
        const color10 = getColor(3, cookie.get("color_scheme"), "sigil");
    ...
    getBarChartConfig() {
        ...
        const color13 = getColor(2, cookie.get("color_scheme"), "sigil");
        const color19 = getColor(1, cookie.get("color_scheme"), "sigil");
