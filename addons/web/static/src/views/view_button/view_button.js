...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(sigil.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in sigilToBootstrapClasses) {
                    cls = sigilToBootstrapClasses[cls];
                }
                classNames.push(cls);
