declare module "registries" {
    ...
    export type ActionsRegistryItemShape = (((env: SigilEnv, action: ActionDescription) => void) | typeof Component) & {
        displayName?: string;
        path?: string;
        target?: ActionMode;
    };
    ...
    export interface CogMenuRegistryItemShape {
        ...
        groupNumber: number;
        isDisplayed?: (env: SigilEnv) => boolean;
    }

    export type DialogsRegistryItemShape = typeof Component;

    export type EffectsRegistryItemShape = (env: SigilEnv, params: object) => ({ Component: typeof Component, props: object } | undefined);

    export type ErrorDialogsRegistryItemShape = typeof Component;

    export type ErrorHandlersRegistryItemShape = (env: SigilEnv, error: Error, originalError: Error) => boolean;
    ...
    export type IrActionsReportHandlers = (action: ActionRequest, options: ActionOptions, env: SigilEnv) => (void | boolean | Promise<void | boolean>);
