...
import { Component, useRef, useSubEnv } from "@sigil/owl";
 ...
 * It uses a feature to automatically create links to other sigil pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
