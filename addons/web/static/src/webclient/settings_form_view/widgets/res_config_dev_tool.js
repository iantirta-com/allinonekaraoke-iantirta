...
import { Component, onWillStart } from "@sigil/owl";
...
export class ResConfigDevTool extends Component {
    ...
    setup() {
        this.isDebug = Boolean(sigil.debug);
        this.isAssets = sigil.debug.includes("assets");
        this.isTests = sigil.debug.includes("tests");
