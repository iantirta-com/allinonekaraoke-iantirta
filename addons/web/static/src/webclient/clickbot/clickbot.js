...
import { App, reactive } from "@sigil/owl";
...
function setup(light, currentState) {
    env = sigil.__WOWL_DEBUG__.root.env;
    ...
    isEnterprise = sigil.info && sigil.info.isEnterprise;
...
async function _clickEverywhere(xmlId, light, currentState) {
    ...
    console.log(`Sigil flavor: ${isEnterprise ? "Enterprise" : "Community"}`);
