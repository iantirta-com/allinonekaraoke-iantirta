 ...
 */
export function sigilmark(text) {
    /**
     * Mapping of patterns - replacer functions to apply to sigilmarked strings.
     *
     ...
     *
     * Note: this list is declared inline in the `sigilmark` function to avoid other
