import { App, EventBus } from "@sigil/owl";
...
/**
 * Return a value Sigil Env object
 *
 * @returns {SigilEnv}
 */
 ...
 * in `__WOWL_DEBUG__`
 *
 * @param {import("@sigil/owl").Component} component the component to mount
