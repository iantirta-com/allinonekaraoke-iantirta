...
import { after, describe, expect, mockFetch, test } from "@sigil/hoot";
...
describe(parseUrl(import.meta.url), () => {
    ...
    test("fetch with internal URLs should return default value", async () => {
        ...
        const internal = await fetch("/sigil").then((res) => res.text());
        ...
        expect.verifySteps(["http://some.url", "/sigil", "data:text/html,<body></body>"]);
    });
