import { after, expect, registerDebugInfo } from "@sigil/hoot";
import { Deferred } from "@sigil/hoot-mock";
import {
    MockServer,
    asyncStep,
    defineModels,
...
import { on, runAllTimers, waitUntil } from "@sigil/hoot-dom";
 ...
 *
 * @typedef {import("@web/env").SigilEnv} SigilEnv
...
/** @type {Record<string, (env: SigilEnv, id: string, payload: any) => any>} */
const busMessageHandlers = {};
/** @type {Map<SigilEnv, { id: number, type: string, payload: NotificationPayload }[]>} */
 ...
 *
 * @param {string} type
 * @param {(env: SigilEnv, id: string, payload: any) => any} handler
 */
