...
import sigil
from sigil import api, modules
from .models.bus import dispatch
from .tools import orjson
from sigil.http import root, Request, Response, SessionExpiredException, get_default_session
from sigil.modules.registry import Registry
from sigil.service import model as service_model
from sigil.service.server import CommonServer
from sigil.service.security import check_session
...
class Websocket:
    ...
    def __init__(self, sock, session, cookies):
        ...
        self.__selector = (
            ...
            if sigil.evented and hasattr(selectors, 'PollSelector')
...
class WebsocketConnectionHandler:
    ...
    def _handle_public_configuration(cls, request):
        if not os.getenv('SIGIL_BUS_PUBLIC_SAMESITE_WS'):
            return
