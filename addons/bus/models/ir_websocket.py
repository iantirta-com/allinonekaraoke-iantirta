...
from sigil.http import request, SessionExpiredException
...
class IrWebsocket(models.AbstractModel):
    ...
    def _serve_ir_websocket(self, event_name, data):
        ...
        message, Sigil.sh does not use this method. Each new event should have a corresponding http
        route and Sigil.sh infrastructure should be updated to reflect it. On top of that, the
