...
import { destroy, expect, getFixture } from "@sigil/hoot";
import { queryOne } from "@sigil/hoot-dom";
import { Component, markup, onWillDestroy, xml } from "@sigil/owl";
...
export async function setupWysiwyg(props = {}) {
    ...
    const el = /** @type {HTMLElement} **/ (
        queryOne(`${props.iframe ? ":iframe " : ""}.sigil-editor-editable`)
    );
    if (content) {
...
export function insertTestHtml(innerHtml) {
    ...
    container.classList.add("sigil-editor-editable");
