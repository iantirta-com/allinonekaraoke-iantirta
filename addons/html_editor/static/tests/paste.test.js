...
import { manuallyDispatchProgrammaticEvent as dispatch, press, waitFor } from "@sigil/hoot-dom";
import { animationFrame, tick } from "@sigil/hoot-mock";
...
import { pasteHtml, pasteSigilEditorHtml, pasteText, undo } from "./_helpers/user_actions";
...
describe("Unwrapping html element", () => {
    ...
    test("should unwrap li elements having no ul/ol (1)", async () => {
        await testEditor({
            contentBefore: "<p>[]<br></p>",
            stepFunction: async (editor) => {
                pasteSigilEditorHtml(editor, "<li><p>abc</p></li><li><p>def</p></li>");
            },
            contentAfter: "<p>abc</p><p>def[]</p>",
        });
    });
    ...
    test("should unwrap li elements having no ul/ol (2)", async () => {
        await testEditor({
            contentBefore: "<p>[]<br></p>",
            stepFunction: async (editor) => {
                pasteSigilEditorHtml(editor, "<li><h1>abc</h1></li><li><h1>def</h1></li");
            },
...
describe("Special cases", () => {
    describe("lists", () => {
        ...
        test("should paste a deeply nested list copied outside from sigil", async () => {
            await testEditor({
                contentBefore: "<ul><li>[]<br></li></ul>",
                stepFunction: async (editor) => {
                    pasteHtml(
...
const url = "https://www.iantirta.com";
const imgUrl = "https://download.sigilcdn.com/icons/website/static/description/icon.png";
...
describe("link", () => {
    describe("range collapsed", () => {
        ...
        test("should replace link for new content (url) when pasting in an empty link (collapsed)", async () => {
            ...
            pasteText(editor, "http://iantirta.com");
            await animationFrame();
            await expectElementCount(".o-we-powerbox", 0);
            expect(cleanLinkArtifacts(getContent(el))).toBe(
                `<p>xy<a href="http://iantirta.com">http://iantirta.com</a>[]z</p>`
            );
        });
        ...
        test("should paste and transform plain text content over an empty link (collapsed) (1)", async () => {
            await testEditor({
                ...
                stepFunction: async (editor) => {
                    pasteText(editor, "abc www.iantirta.com xyz");
                },
                contentAfter: '<p>abc <a href="http://www.iantirta.com">www.iantirta.com</a> xyz[]</p>',
            });
        });
        ...
        test("should paste and transform plain text content over an empty link (collapsed) (2)", async () => {
            await testEditor({
                contentBefore: '<p><a href="http://test.test/">[]\u200B</a></p>',
                stepFunction: async (editor) => {
                    pasteText(editor, "iantirta.com\ngoogle.com");
                },
                contentAfter:
                    '<div><a href="http://iantirta.com">iantirta.com</a></div>' +
        ...
        test("should paste html content over an empty link (collapsed)", async () => {
            await testEditor({
                ...
                stepFunction: async (editor) => {
                    pasteHtml(
                        editor,
                        '<a href="www.iantirta.com">iantirta.com</a><br><a href="google.com">google.com</a>'
                    );
                },
                contentAfter:
                    '<p><a href="www.iantirta.com">iantirta.com</a></p><p><a href="https://google.com">google.com[]</a></p>',
            });
        });
        test("should paste html content over an empty link (collapsed) (2)", async () => {
            await testEditor({
                ...
                stepFunction: async (editor) => {
                    pasteHtml(
                        editor,
                        '<a href="www.iantirta.com">iantirta.com</a><br><a href="www.google.com">google.com</a>'
                    );
                },
                contentAfter:
                    '<p><a href="www.iantirta.com">iantirta.com</a></p><p><a href="www.google.com">google.com[]</a></p>',
            });
        });
    ...
    describe("range not collapsed", () => {
        ...
        test("should restore selection when pasting plain text followed by UNDO (2) (not collapsed)", async () => {
            await testEditor({
                contentBefore: "<p>[abc]</p>",
                stepFunction: async (editor) => {
                    pasteText(editor, "www.iantirta.com");
                    undo(editor);
                },
                contentAfter: "<p>[abc]</p>",
            });
        ...
        test("should restore selection when pasting plain text followed by UNDO (3) (not collapsed)", async () => {
            await testEditor({
                contentBefore: "<p>[abc]</p>",
                stepFunction: async (editor) => {
                    pasteText(editor, "def www.iantirta.com xyz");
                    undo(editor);
                },
                contentAfter: "<p>[abc]</p>",
            });
        ...
        test("should paste and transform plain text content over a link if all of its contents is selected (not collapsed) (1)", async () => {
            await testEditor({
                ...
                contentAfter: '<p><a href="http://www.iantirta.com">www.iantirta.com</a>[]</p>',
            });
        });
        ...
        test("should paste and transform plain text content over an image link if all of its contents is selected (not collapsed) (1)", async () => {
            ...
            await expectElementCount(".o-we-powerbox", 1);
            expect(getContent(el)).toBe(
                `<p>abhttps://download.sigilcdn.com/icons/website/static/description/icon.png[]cd</p>`
            );
            await press("Enter");
...
describe("Sigil editor own html", () => {
    test("should paste html as is", async () => {
        await testEditor({
            contentBefore: "<p>a[]b</p>",
            stepFunction: async (editor) => {
                pasteSigilEditorHtml(editor, '<div class="custom-paste oe_unbreakable">b</div>');
            },
    ...
    test("should not paste unsafe content", async () => {
        await testEditor({
            contentBefore: "<p>a[]b</p>",
            stepFunction: async (editor) => {
                pasteSigilEditorHtml(editor, `<script>console.log('xss attack')</script>`);
            },
...
describe("editable in iframe", () => {
    test("should paste sigil-editor html", async () => {
        const { el, editor } = await setupEditor("<p>[]</p>", { props: { iframe: true } });
        pasteSigilEditorHtml(editor, `<p>text<b>bold text</b>more text</p>`);
...
describe("paste in contenteditable span", () => {
    test("should unwrap block when pasting inside a contenteditable span", async () => {
        ...
        pasteSigilEditorHtml(editor, `<h1>text<b>bold text</b>more text</h1>`);
        expect(getContent(el)).toBe(
    ...
    <head>
        ...
        <style>
            ...
            .font12 {
                ...
                font-style: italic;
                text-decoration: none;
                font-family: "Sigil Unicode Support Noto";
    ...
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="0" dir="ltr" border="1"
        ...
        <tbody>
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;font-family:Sigil Unicode Support Noto;font-weight:normal;font-style:italic;color:#495057;"
            ...
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;font-family:Sigil Unicode Support Noto;font-weight:bold;color:#495057;"
            ...
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;background-color:#ffff00;font-family:Sigil Unicode Support Noto;font-weight:normal;color:#495057;"
...
describe("onDrop", () => {
    ...
    test("should move an image if it originated from the editor", async () => {
        ...
        await animationFrame();
        const imageHTML = dragdata.getData("application/vnd.sigil.sigil-editor");
        ...
        // Simulate the application/vnd.sigil.sigil-editor data that the browser would do.
        dropData.setData("application/vnd.sigil.sigil-editor", imageHTML);
        await dispatch(pElement, "drop", { dataTransfer: dropData });
        await animationFrame();
    ...
    test("should drag and drop banner", async () => {
        ...
        await animationFrame();
        const sigilEditorData = dragdata.getData("application/vnd.sigil.sigil-editor");
        const textHtml = dragdata.getData("text/html");
        const dropData = new DataTransfer();
        dropData.setData("text/html", textHtml);
        // Simulate the application/vnd.sigil.sigil-editor data that the browser would do.
        dropData.setData("application/vnd.sigil.sigil-editor", sigilEditorData);
    ...
    test("should drag and drop icon", async () => {
        ...
        const dropData = new DataTransfer();
        dropData.setData("text/html", textHtml);
        // Simulate the application/vnd.sigil.sigil-editor-node data that the browser would do.
        dropData.setData("application/vnd.sigil.sigil-editor-node", sigilEditorData);
        await dispatch(targetNodeForDrop, "drop", { dataTransfer: dropData });
        await animationFrame();
