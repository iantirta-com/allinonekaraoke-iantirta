...
import { animationFrame, press } from "@sigil/hoot-dom";
...
describe("inline code", () => {
    ...
    test.tags("desktop");
    test("should not open the sigil global command bar when pressing ctrl+k inside a inline code element", async () => {
