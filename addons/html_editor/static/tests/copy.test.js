...
describe("range not collapsed", () => {
    test("should copy a selection as text/plain, text/html and application/vnd.sigil.sigil-editor only text", async () => {
        ...
        expect(clipboardData.getData("application/vnd.sigil.sigil-editor")).toBe("<p>bcd</p>");
    });

    test("should copy a selection as text/plain, text/html and application/vnd.sigil.sigil-editor with a <br>", async () => {
        ...
        expect(clipboardData.getData("application/vnd.sigil.sigil-editor")).toBe("<p>abc<br>efg</p>");
    });

    test.tags("focus required");
    test("should copy a selection as text/plain, text/html and application/vnd.sigil.sigil-editor in table", async () => {
        ...
        expect(clipboardData.getData("application/vnd.sigil.sigil-editor")).toBe(
            "<table><tbody><tr><td><ul><li>a</li><li>b</li><li>c</li></ul></td><td><br></td></tr></tbody></table>"
        );
    });

    test("should copy a selection as text/html and application/vnd.sigil.sigil-editor in table", async () => {
        await setupEditor(
    ...
    test("should copy the selection as a single list item (1)", async () => {
        ...
        expect(clipboardData.getData("application/vnd.sigil.sigil-editor")).toBe("First");
    });
    ...
    test("should copy the selection as a single list item (2)", async () => {
        ...
        expect(clipboardData.getData("application/vnd.sigil.sigil-editor")).toBe("List");
    });
    ...
    test("should copy style and font of ancestors up to a block", async () => {
        ...
        expect(clipboardData.getData("application/vnd.sigil.sigil-editor")).toBe("<p><b>c</b></p>");
    });
    ...
    test("should not clone ancestors outside the contenteditable (block)", async () => {
        ...
        expect(clipboardData.getData("application/vnd.sigil.sigil-editor")).toBe("<b>c</b>");
    });
    ...
    test("should not clone ancestors outside the contenteditable (inline)", async () => {
        ...
        expect(clipboardData.getData("application/vnd.sigil.sigil-editor")).toBe("c");
    });

    test("should not copy to sigil-editor clipboard when selection is outside the contenteditable", async () => {
        await setupEditor(
        ...
        expect(clipboardData.getData("application/vnd.sigil.sigil-editor")).toBe("");
        expect(clipboardData.types).not.toInclude("application/vnd.sigil.sigil-editor");
    });
});
