...
test("properties: html", async () => {
    ...
    expect(`[name="properties"] .sigil-editor-editable`).toHaveCount(1);
    expect(`[name="properties"] .sigil-editor-editable .o-paragraph`).toHaveInnerHTML(
        "<b> test </b>"
    );

    setSelection({
        anchorNode: queryOne(`[name="properties"] .sigil-editor-editable .o-paragraph b`),
        anchorOffset: 0,
    });
...
test("properties: html migration", async () => {
    ...
    expect(`[name="properties"] .sigil-editor-editable`).toHaveCount(1);
    expect(`[name="properties"] .sigil-editor-editable a[href*="excalidraw.com"]`).toHaveCount(1);
