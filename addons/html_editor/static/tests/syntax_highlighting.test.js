...
import { animationFrame, click, press, queryOne, waitFor } from "@sigil/hoot-dom";
...
test.tags("desktop");
test("should not open the sigil global command bar when pressing ctrl+k inside a syntax-highlighted code block", async () => {
    ...
    // Pressing ctrl+k to open sigil global command bar
    await press(["ctrl", "k"]);
    await animationFrame();
