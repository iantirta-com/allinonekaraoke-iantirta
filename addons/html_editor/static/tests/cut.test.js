...
describe("range not collapsed", () => {
    test("should cut a selection as text/plain, text/html and application/vnd.sigil.sigil-editor (1)", async () => {
        await testEditor({
    ...
    test("should cut a selection as text/plain, text/html and application/vnd.sigil.sigil-editor (2)", async () => {
        await testEditor({
