...
/**
 * @typedef { Object } CollaborationSigilShared
 * @property { CollaborationSigilPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationSigilPlugin extends Plugin {
    static id = "collaborationSigil";
        ...
        return new PeerToPeer({
            ...
            onNotification: async (notification) => {
                ...
                switch (notificationName) {
                    case "ptp_remove":
                        // todo: to implement
                        // this.sigilEditor.multiselectionRemove(notificationPayload);
                        break;
                    case "ptp_disconnect":
                        this.ptp.removePeer(fromPeerId);
                        // todo: to implement
                        // this.sigilEditor.multiselectionRemove(fromPeerId);
                        break;
    ...
    async resetFromServerAndResyncWithPeers() {
        ...
        // lastHistoryId will be different if the sigil bus did not have time to
        // notify the user.
    ...
    showConflictDialog() {
        ...
        //     return;
        // }
        // const content = markup(this.sigilEditor.editable.cloneNode(true).outerHTML);
