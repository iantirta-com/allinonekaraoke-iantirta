...
export class CollaborationSelectionAvatarPlugin extends Plugin {
    ...
    static dependencies = ["history", "position", "localOverlay", "collaborationSigil"];
    ...
    /**
     * @param {import("./collaboration_sigil_plugin").CollaborationSelection} selection
     */
    ...
    drawPeerAvatar(selectionInfo) {
        ...
        const peerMetadata = this.dependencies.collaborationSigil.getPeerMetadata(peerId);
        if (!peerMetadata) {
            return;
        }
