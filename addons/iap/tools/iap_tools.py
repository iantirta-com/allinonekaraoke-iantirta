...
from sigil import exceptions, modules, _
from sigil.tools import email_normalize, exception_to_unicode

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap.iantirta.com'
...
_MAIL_PROVIDERS = {
    ...
    'bk.ru', 'mail.iantirta.com', 'gmail.con', 'fiu.edu', 'gmal.com', 'useemlikefun.com', 'google.com', 'trbvn.com', 'yopmail.com', 'ya.ru',
...
_MAIL_DOMAIN_BLACKLIST = _MAIL_PROVIDERS | {'iantirta.com'}
...
def iap_jsonrpc(url, method='call', params=None, timeout=15):
    ...
    try:
        ...
        raise exceptions.AccessError(
            _("An error occurred while reaching %s. Please contact Sigil support if this error persists.", url)
        )
