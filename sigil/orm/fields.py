...
from sigil.exceptions import AccessError, MissingError
from sigil.tools import Query, SQL, reset_cached_properties, sql
from sigil.tools.constants import PREFETCH_MAX
from sigil.tools.misc import SENTINEL, ReadonlyDict, Sentinel, unique
...
_logger = logging.getLogger('sigil.fields')
...
class Field(typing.Generic[T]):
    ...
    def _get_attrs(self, model_class: type[BaseModel], name: str) -> dict[str, typing.Any]:
        ...
        if 'group_operator' in attrs:
            warnings.warn("Since Sigil 18, 'group_operator' is deprecated, use 'aggregator' instead", DeprecationWarning, stacklevel=2)
