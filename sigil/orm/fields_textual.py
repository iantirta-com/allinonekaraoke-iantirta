...
from sigil.netsvc import COLOR_PATTERN, DEFAULT, GREEN, RED, ColoredFormatter
from sigil.tools import SQL, html_normalize, html_sanitize, html2plaintext, is_html_empty, plaintext2html, sql
from sigil.tools.misc import OrderedSet, SENTINEL, Sentinel
from sigil.tools.sql import pattern_to_translated_trigram_pattern, pg_varchar, value_to_translated_trigram_pattern
from sigil.tools.translate import html_translate
...
class Html(BaseString):
    ...
    def _get_attrs(self, model_class, name):
        ...
        # we do not need this Microsoft Outlook client feature for emails displayed Sigil's web client.
