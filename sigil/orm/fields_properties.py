...
from sigil.exceptions import AccessError, UserError, MissingError
from sigil.tools import SQL, OrderedSet, is_list_of, html_sanitize
from sigil.tools.misc import frozendict, has_list_types
...
class Properties(Field):
    ...
    like Sigil fields but without being independently stored in database.
    ...
    current record. The container must have a :class:`~sigil.fields.PropertiesDefinition`
...
class PropertiesDefinition(Field):
    """ Field used to define the properties definition (see :class:`~sigil.fields.Properties`
