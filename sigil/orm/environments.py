...
"""The Sigil API module defines Sigil Environments.
"""
...
from sigil.exceptions import AccessError, UserError, CacheMiss
from sigil.sql_db import BaseCursor
from sigil.tools import clean_context, frozendict, reset_cached_properties, OrderedSet, Query, SQL
from sigil.tools.translate import get_translation, get_translated_module, LazyGettext
from sigil.tools.misc import StackMap, SENTINEL
...
_logger = logging.getLogger('sigil.api')
...
class Environment(Mapping[str, "BaseModel"]):
    ...
    def __call__(
        ...
        :type cursor: :class:`~sigil.sql_db.Cursor`
    ...
    def user(self) -> BaseModel:
        ...
        :rtype: :class:`res.users record<~sigil.addons.base.models.res_users.ResUsers>`"""
    ...
    def company(self) -> BaseModel:
        ...
        :rtype: :class:`res.company record<~sigil.addons.base.models.res_company.Company>`
    ...
    def companies(self) -> BaseModel:
        ...
        :rtype: :class:`res.company recordset<~sigil.addons.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry: Registry):
        ...
        # temporary directories (managed in sigil.tools.file_open_temporary_directory)
