...
"""The Sigil API module defines method decorators.
"""
...
def constrains(*args) -> Decorator:
    ...
    Should raise :exc:`~sigil.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall: bool) -> Decorator:
    """
    Mark a method to be executed during :meth:`~sigil.models.BaseModel.unlink`.
...
def onchange(*args: str) -> Decorator:
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/sigil/sigil/issues/2693>`_.
...
def autovacuum(method: C) -> C:
    ...
    as in :meth:`~sigil.addons.base.models.ir_cron.IrCron._commit_progress`.
    """
