...
from sigil.tools import SQL, human_size
...
class Image(Binary):
    ...
    :param bool verify_resolution: whether the image resolution should be verified
        ...
        See :class:`sigil.tools.image.ImageProcess` for maximum image resolution (default: ``50e6``).
    ...
    def _image_process(self, value, env):
        ...
        from sigil.tools.image import image_process  # noqa: PLC0415
