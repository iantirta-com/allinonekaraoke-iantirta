...
from sigil.exceptions import AccessError, MissingError, UserError
from sigil.tools import SQL, OrderedSet, Query, sql, unique
from sigil.tools.constants import PREFETCH_MAX
from sigil.tools.misc import SENTINEL, Sentinel, unquote
...
if typing.TYPE_CHECKING:
    ...
    from sigil.tools.misc import Collector
...
class Many2one(_Relational):
    ...
    :param bool check_company: Mark the field to be verified in
        :meth:`~sigil.models.Model._check_company`. Has a different behaviour
...
class Many2many(_RelationalMulti):
    ...
    :param bool check_company: Mark the field to be verified in
        :meth:`~sigil.models.Model._check_company`. Add a default company
