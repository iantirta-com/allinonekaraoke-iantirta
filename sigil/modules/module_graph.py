...
from sigil.tools import reset_cached_properties, OrderedSet
...
class ModuleNode:
    """
    Loading and upgrade info for an Sigil module
    """
...
class ModuleGraph:
    """
    Sorted Sigil modules ordered by (module.phase, module.depth, module.name)
    """
