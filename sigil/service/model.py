...
from sigil import api, http
from sigil.exceptions import (
    AccessDenied,
    AccessError,
    ConcurrencyError,
    UserError,
...
from sigil.tools.safe_eval import _UNSAFE_ATTRIBUTES
...
def retrying(func, env):
    ...
    :param sigil.api.Environment env: The environment where the registry
