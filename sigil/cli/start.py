...
from sigil.modules.module import Manifest, MANIFEST_NAMES
from sigil.service.db import _create_empty_database, DatabaseExists
from sigil.tools import config


class Start(Command):
    """ Quickly start the sigil server with default options """
