...
from sigil.tools import cloc, config
from . import Command
...
class Cloc(Command):
    ...
    description = """
        Sigil cloc is a tool to count the number of relevant lines written
        ...
        It has two modes of operation, either by providing a path:
            ...
            sigil-bin cloc -p module_path

        Or by providing the name of a database:

            sigil-bin --addons-path=dirs cloc -d database
