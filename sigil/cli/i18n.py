...
from sigil.modules import get_module_path
from sigil.modules.registry import Registry
from sigil.tools import OrderedSet, config
from sigil.tools.translate import TranslationImporter, load_language, trans_export
    ...
    def __init__(self, *args, **kwargs):
        ...
        for parser in (self.import_parser, self.export_parser, self.loadlang_parser):
            ...
            parser.epilog = textwrap.dedent("""\
                ...
                Examples:
                    sigil-bin i18n loadlang -l en         # English (U.S.)
                    sigil-bin i18n loadlang -l es es_AR   # Spanish (Spain, Argentina)
                    sigil-bin i18n loadlang -l sr@latin   # Serbian (Latin)
            """)
