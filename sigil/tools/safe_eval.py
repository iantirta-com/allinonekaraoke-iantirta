...
_BUBBLEUP_EXCEPTIONS = (
    sigil.exceptions.ConcurrencyError,  # let retrying handle this error
    sigil.exceptions.UserError,
    sigil.exceptions.RedirectWarning,
...
`sigil.tools.safe_eval.wrap_module` to generate a wrapper recursively
whitelisting allowed attributes.

Pre-wrapped modules are provided as attributes of `sigil.tools.safe_eval`.
""")
    return d
...
from sigil._monkeypatches.pytz import patch_module as patch_pytz  # noqa: E402, F401
patch_pytz()
