...
class lazy_property(functools.cached_property):
    def __init__(self, func):
        super().__init__(func)
        warnings.warn(
            "lazy_property is deprecated since Sigil 19, use `functools.cached_property`",
    ...
    def reset_all(instance):
        warnings.warn(
            "lazy_property is deprecated since Sigil 19, use `reset_cache_properties` directly",
            category=DeprecationWarning,
        )
