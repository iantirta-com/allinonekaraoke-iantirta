...
This tool provides utilities to duplicate records across models in Sigil, while maintaining referential integrity,
...
from sigil.fields import Field, Many2one
from sigil.models import Model
