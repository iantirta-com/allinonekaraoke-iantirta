...
from sigil import _
from sigil.addons.base.models.res_company import ResCompany
from sigil.addons.base.models.res_users import ResUsers
from sigil.tools.pdf import PdfReader, PdfWriter, ArrayObject, ByteStringObject, DictionaryObject, NameObject, NumberObject, create_string_object, DecodedStreamObject as StreamObject
...
class PdfSigner:
    ...
    def sign_pdf(self, visible_signature: bool = False, field_name: str = "Sigil Signature", signer: Optional[ResUsers] = None) -> Optional[io.BytesIO]:
