...
class _Cleaner(clean.Cleaner):
    ...
    def kill_conditional_comments(self, doc):
        ...
        https://github.com/sigil/sigil/pull/119325/files#r1301064789
...
def tag_quote(el):
    ...
    # sigil, gmail and outlook automatic signature wrapper
    is_signature_wrapper = 'sigil_signature_wrapper' in el_class or 'gmail_signature' in el_class or el_id == "Signature"
...
def plaintext2html(text: str, container_tag: str | None = None, with_paragraph: bool = True) -> markupsafe.Markup:
    ...
    html entities, using :func:`~sigil.tools.misc.html_escape`.
...
def email_normalize(text, strict=True):
    ...
    within sigil, this assumption is certain to fall short for international
...
def _normalize_email(email):
    ...
    introduction of smtp-utf8 within sigil, this assumption is certain to fall
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@iantirta.com
    * Output: "Admin" <notifications@iantirta.com>
    """
