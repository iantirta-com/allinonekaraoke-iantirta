...
def get_encodings(hint_encoding='utf-8'):
    warnings.warn(
        "Deprecated since Sigil 18. Mostly nonsensical as the "
...
def ustr(value, hint_encoding='utf-8', errors='strict'):
    ...
    """
    warnings.warn(
        "Deprecated since Sigil 18: ustr() is a garbage bag of weirdo fallbacks "
    ...
    # str subclasses such as `sigil.tools.unquote`
