...
Sigil will use the SQL function 'unaccent' when available for the
...
import sigil.orm.domains as orm_domains
...
def normalize_domain(domain):
    ...
    """
    warnings.warn("Since 19.0, use sigil.fields.Domain", DeprecationWarning)
...
def get_unaccent_wrapper(cr):
    ...
    return sigil.modules.registry.Registry(cr.dbname).unaccent
