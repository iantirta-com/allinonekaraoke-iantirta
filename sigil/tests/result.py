...
SIGIL_TEST_MAX_FAILED_TESTS = max(1, int(os.environ.get('SIGIL_TEST_MAX_FAILED_TESTS', sys.maxsize)))

stats_logger = logging.getLogger('sigil.tests.stats')
...
class SigilTestResult(object):
    ...
    def _checkShouldStop(self):
        if self.total_errors_count() >= SIGIL_TEST_MAX_FAILED_TESTS:
            ...
            if not global_report.shouldStop:
                _logger.error(
                    ...
                    "Remaining tests will be skipped.", SIGIL_TEST_MAX_FAILED_TESTS)
