# -*- coding: utf-8 -*-
"""
The module :mod:`sigil.tests.form` provides an implementation of a client form
...
from sigil.tools.safe_eval import safe_eval
...
class Form:
    ...
    * properly handle defaults & onchanges around x2many fields.
    ...
    of :class:`~sigil.fields.Many2one` fields, one can assign a recordset::
    ...
    For :class:`~sigil.fields.Many2many` fields, the field itself is a
    :class:`~sigil.tests.common.M2MProxy` and can be altered by adding or
    removing records::
    ...
    Finally :class:`~sigil.fields.One2many` are reified as :class:`~O2MProxy`.

    Because the :class:`~sigil.fields.One2many` only exists through its parent,
...
class O2MProxy(X2MProxy):
    ...
    def new(self):
        ...
        :class:`~sigil.fields.One2many` record, properly initialised.
    ...
    def edit(self, index):
        ...
        :class:`~sigil.fields.One2many` record.
