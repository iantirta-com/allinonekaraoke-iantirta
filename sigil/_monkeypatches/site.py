...
def patch_evented():
    ...
    This should be executed early. It will initialize the `sigil.evented` variable.
    """
    if sigil.evented or not (len(sys.argv) > 1 and sys.argv[1] == 'gevent'):
        return
    ...
    def gevent_wait_callback(conn, timeout=None):
        ...
        # under the BSD license (see in sigil/debian/copyright)
        while 1:
            state = conn.poll()
