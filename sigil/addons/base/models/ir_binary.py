...
from sigil.exceptions import MissingError, UserError
from sigil.http import Stream, request
from sigil.tools import file_open, replace_exceptions
from sigil.tools.image import image_guess_size_from_field_name, image_process
from sigil.tools.mimetypes import MIMETYPE_HEAD_SIZE, get_extension, guess_mimetype
from sigil.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:sigil.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~sigil.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`sigil.tools.image.image_process`.
