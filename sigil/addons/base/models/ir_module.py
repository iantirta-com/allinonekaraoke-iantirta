...
from sigil.exceptions import AccessDenied, UserError, ValidationError
from sigil.fields import Domain
from sigil.tools import config
from sigil.tools.parse_version import parse_version
from sigil.tools.misc import topological_sort, get_flag
from sigil.tools.translate import TranslationImporter, get_po_paths, get_datafile_translation_path
from sigil.http import request
from sigil.modules.module import Manifest, MissingDependency
...
class IrModuleModule(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'Sigil Enterprise Edition License v1.0'),
        ('OPL-1', 'Sigil Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('Sigil Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        if self.search_count([('state', 'in', ('to install', 'to upgrade', 'to remove'))], limit=1):
            raise UserError(_("Sigil is currently processing another module operation.\n"
        ...
        try:
            ...
            self.env.cr.rollback()
            raise UserError(_("Sigil is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(sigil.tools.config['server_wide_modules']) & set(self.mapped('name'))
