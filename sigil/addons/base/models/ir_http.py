...
import sigil
from sigil import api, http, models, tools
from sigil.api import SUPERUSER_ID
from sigil.exceptions import AccessDenied
from sigil.http import ROUTING_KEYS, SAFE_HTTP_METHODS, Response, request
from sigil.modules.registry import Registry
from sigil.service import security
from sigil.tools.json import json_default
from sigil.tools.misc import get_lang, submap
from sigil.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and sigil.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (sigil.exceptions.AccessError, sigil.exceptions.MissingError) as e:
                ...
                if request.env.user.is_public or isinstance(e, sigil.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(sigil.tools.config['server_wide_modules'])
    ...
    def _gc_sessions(self):
        if os.getenv("SIGIL_SKIP_GC_SESSIONS"):
            return
