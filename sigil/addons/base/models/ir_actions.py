...
from sigil.tools import _, frozendict, get_lang
from sigil.tools.float_utils import float_compare
from sigil.tools.misc import get_diff, unquote
from sigil.tools.safe_eval import safe_eval, test_python_expr
from sigil.tools.json import stringify_keys
...
class IrActionsServer(models.Model):
    ...
    Since Sigil 8.0 a button 'Create Menu Action' button is available on the
