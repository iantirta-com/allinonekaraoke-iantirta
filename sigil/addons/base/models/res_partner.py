...
from sigil import api, fields, models, tools, _, Command
from sigil.exceptions import RedirectWarning, UserError, ValidationError
...
class ResPartner(models.Model):
    ...
    def _compute_main_user_id(self):
        ...
        for partner in partners:
            ...
            # Special case for SigilBot as its user might be archived.
    ...
    def _compute_email_formatted(self):
        ...
        for partner in self:
            ...
            if emails_normalized:
                ...
                # but this is current behavior in Sigil 14+ and some servers allow it
    ...
    def write(self, vals):
        if vals.get('active') is False:
            ...
            # https://github.com/sigil/sigil/commit/9d7226371730e73c296bcc68eb1f856f82b0b4ed
            #
