...
from sigil import api, Command, fields, models
from sigil.tools import OrderedSet
from sigil.tools.translate import _, code_translations, LazyTranslate
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str, *, savepoint):
        ...
        callable taking a record-ish (a dictionary representing an sigil
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`sigil.models.Model.write` expects.

        :param model: :class:`sigil.models.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str, *, savepoint):
        ...
        :type field: :class:`sigil.fields.Field`
