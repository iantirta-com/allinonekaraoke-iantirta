...
from sigil.tools import frozendict, reset_cached_properties, split_every, sql, unique, OrderedSet, SQL
from sigil.tools.safe_eval import safe_eval, datetime, dateutil, time
from sigil.tools.translate import FIELD_TRANSLATE, LazyTranslate, _
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in sigil.modules.loading.
...
class IrModelFields(models.Model):
    ...
    def _drop_column(self):
        from sigil.orm.model_classes import pop_field
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            if vals.get('translate') and not isinstance(vals['translate'], str):
                _logger.warning("Deprecated since Sigil 19, ir.model.fields.translate becomes Selection, the value should be a string")
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement Sigil many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by Sigil
    ...
    def _module_data_uninstall(self, modules_to_remove):
        ...
        """
        from sigil.orm.model_classes import add_field
