...
from sigil.exceptions import AccessError, ValidationError
from sigil.fields import Domain
from sigil.tools import config, SQL
...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - sigil/addons/test_access_rights/tests/test_feedback.py
        # - sigil/addons/test_access_rights/tests/test_ir_rules.py
        # - sigil/addons/base/tests/test_orm.py (/home/dle/src/sigil/master-nochange-fp/sigil/addons/base/tests/test_orm.py)
        self.env.flush_all()
        self.env.registry.clear_cache()
        return res
    ...
    def _make_access_error(self, operation, records):
        ...
        if company_related:
            ...
            if suggested_companies and len(suggested_companies) != 1:
                resolution_info += _('\n\nNote: this might be a multi-company issue. Switching company may help - in Sigil, not in real life!')
