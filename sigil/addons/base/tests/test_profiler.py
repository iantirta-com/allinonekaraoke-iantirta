...
from sigil.tests.common import BaseCase, TransactionCase, tagged, new_test_user, HttpCase
from sigil.tools import profiler
from sigil.tools.profiler import Profiler, ExecutionContext
from sigil.tools.speedscope import Speedscope
...
class TestProfiling(TransactionCase):
    ...
    def test_profiler_return(self):
        ...
        self.startClassPatcher(patch('sigil.sql_db.db_connect', return_value=self.registry))
