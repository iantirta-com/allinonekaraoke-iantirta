...
from sigil.tests.common import standalone
from sigil.tests.test_module_operations import install
from sigil.tools import mute_logger
from sigil.tools.convert import ParseError
...
def test_isolated_install(env):
    ...
    try:
        with mute_logger('sigil.modules.registry'):
