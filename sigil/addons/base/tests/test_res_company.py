...
from sigil.tests.common import Command, TransactionCase
...
class TestCompany(TransactionCase):
    ...
    def test_write_company_root_delegated_field_names(self):
        ...
        with patch('sigil.addons.base.models.res_company.ResCompany._get_company_root_delegated_field_names', return_value=["currency_id", "zip"]):
