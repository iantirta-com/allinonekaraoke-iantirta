...
cite="mid:CAEJSRZvWvud8c6Qp=wfNG6O1+wK3i_jb33qVrF7XyrgPNjnyUA@mail.gmail.com"
    ...
    on this Sigil mailinglist, but when you start implying that Postgres
...
<div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; COLOR: #000000">
    <div>Hello</div>
    <div>I have just installed Sigil 9 and I've got the following error:</div>
    <div>&nbsp;</div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content openerp">
                <div class="modal-header"> 
                    <h4 class="modal-title">Sigil Error<span class="o_subtitle text-muted"></span></h4>
                </div>
