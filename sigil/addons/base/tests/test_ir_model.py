...
from sigil.tests import Form, TransactionCase, HttpCase, tagged
...
class TestXMLID(TransactionCase):
    ...
    @mute_logger('sigil.sql_db', 'sigil.addons.base.models.ir_model')
...
class TestIrModelFieldsTranslation(HttpCase):
    def test_ir_model_fields_translation(self):
        ...
        self.start_tour("/sigil", 'ir_model_fields_translation_en_tour', login="admin")
        field.update_field_translations('field_description', {'en_US': 'Login2'})
        # check the name column of res.users is displayed as 'Login2'
        self.start_tour("/sigil", 'ir_model_fields_translation_en_tour2', login="admin")
        ...
        self.start_tour("/sigil", 'ir_model_fields_translation_fr_tour', login="admin")
        ...
        self.start_tour("/sigil", 'ir_model_fields_translation_fr_tour2', login="admin")
