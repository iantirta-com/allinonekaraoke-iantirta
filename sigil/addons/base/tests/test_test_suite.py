...
class TestTestSuite(TestCase):
    ...
    def test_test_suite(self):
        """ Check that SigilSuite handles unittest.TestCase correctly. """
...
class TestRunnerLoggingCommon(TransactionCase):
    ...
    def _check_log_records(self, log_records):
        ...
        for log_record in log_records:
            ...
            self._assert_log_equal(log_record, 'name', 'sigil.addons.base.tests.test_test_suite')
    ...
    def _clean_message(self, message):
        root_path = PurePath(__file__).parents[4]  # removes /sigil/addons/base/tests/test_test_suite.py
        ...
        message = message.replace(f'"{root_path}', '"/root_path/sigil')
...
Traceback (most recent call last):
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in test_raise_subtest
...
Traceback (most recent call last):
  File "/root_path/sigil/sigil/tests/common.py", line $line, in with_users
    func(self, *args, **kwargs)
  File "/root_path/sigil/sigil/tests/common.py", line $line, in warmup
    func(self, *args, **kwargs)
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in test_with_decorators
    raise Exception('This is an error')
...
Traceback (most recent call last):
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in test_call_stack
    alpha()
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in alpha
    beta()
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in beta
    gamma()
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in gamma
    raise Exception('This is an error')
Exception: This is an error
''')
        self.expected_logs = [
...
Traceback (most recent call last):
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in test_call_stack_context_manager
    alpha()
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in alpha
    beta()
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in beta
...
Traceback (most recent call last):
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in test_call_stack_subtest
    alpha()
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in alpha
    beta()
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in beta
...
Traceback (most recent call last):
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in test_assertQueryCount
    with self.assertQueryCount(system=0):
  File "/usr/lib/python/contextlib.py", line $line, in __exit__
    next(self.gen)
  File "/root_path/sigil/sigil/tests/common.py", line $line, in assertQueryCount
...
Traceback (most recent call last):
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in test_reraise
    alpha()
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in alpha
    beta()
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in beta
...
Traceback (most recent call last):
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in test_handle_error
    alpha()
  File "/root_path/sigil/sigil/addons/base/tests/test_test_suite.py", line $line, in alpha
    raise Exception('This is an error2')
