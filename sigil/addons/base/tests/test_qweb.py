...
from sigil.addons.base.models.ir_qweb import QWebError
from sigil.tools import file_open, misc, mute_logger
from sigil.tools.json import scriptsafe as json_scriptsafe
from sigil.exceptions import UserError, MissingError
...
class TestQWebNS(TransactionCase):
    ...
    def test_render_dynamic_xml_with_code_error(self):
        ...
        view1 = self.env['ir.ui.view'].create({
            ...
            'arch': """
                <t t-name="base.dummy">
                    <Invoice xmlns:od="http://iantirta.com/od">
...
class TestQWebBasic(TransactionCase):
    ...
    def test_attf_escaping_2(self):
        ...
        result = """
                <a href="/link/sigil/sub">link</a>
                <a href="/link/sigil/">link2</a>
            """
        values = {'url': 'sigil', 'other': True}
        rendered = self.env['ir.qweb']._render(t.id, values)
        self.assertEqual(rendered.strip(), result.strip())
    ...
    @mute_logger('sigil.addons.base.models.ir_qweb')
    ...
    @mute_logger('sigil.addons.base.models.ir_qweb') # warning for template not found
