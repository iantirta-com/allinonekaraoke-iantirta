...
from sigil.tools.image import image_to_base64
...
class TestIrAttachment(TransactionCaseWithUserDemo):
    ...
    def test_10_image_autoresize(self):
        ...
        with Image.open(os.path.join(dir_path, 'sigil.jpg'), 'r') as logo:
...
class TestPermissions(TransactionCaseWithUserDemo):
    ...
    @mute_logger("sigil.addons.base.models.ir_rule", "sigil.models")
