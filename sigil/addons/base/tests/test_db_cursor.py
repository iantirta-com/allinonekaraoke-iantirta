...
from sigil.tests.common import BaseCase, HttpCase
from sigil.tests.test_cursor import TestCursor
from sigil.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('sigil.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:sigil.sql_db:Found different un-closed cursor', msg)
