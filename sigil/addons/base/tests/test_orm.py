...
from sigil.exceptions import AccessError, LockError
from sigil.tests.common import TransactionCase, tagged
from sigil.tools import mute_logger
from sigil.tools.version_tag_reset import assign_version_tag
...
class TestORM(TransactionCase):
    ...
    @mute_logger('sigil.models', 'sigil.addons.base.models.ir_rule')
