# -*- coding: utf-8 -*-
from sigil.tests import BaseCase, TransactionCase, tagged, BaseCase
from sigil.tests.suite import _logger as test_logger
...
class TestRetry(TestRetryCommon):
    """ Check some tests behaviour when SIGIL_TEST_FAILURE_RETRIES is set"""
