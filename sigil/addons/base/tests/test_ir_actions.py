...
import sigil
from sigil.exceptions import UserError, ValidationError, AccessError
from sigil.tools import mute_logger, frozendict
from sigil.tests import common, tagged
from sigil.addons.base.tests.common import TransactionCaseWithUserDemo
from sigil.addons.base.models.res_partner import ResPartner
from sigil import Command
...
class TestServerActions(TestServerActionsBase):
    def test_00_server_action(self):
        with self.assertLogs('sigil.addons.base.models.ir_actions.server_action_safe_eval',
                             level='DEBUG') as log_catcher:
            self.test_server_action.run()
            self.assertEqual(log_catcher.output, [
                'DEBUG:sigil.addons.base.models.ir_actions.server_action_safe_eval:This is a test debug log',
                'INFO:sigil.addons.base.models.ir_actions.server_action_safe_eval:This is a test info log',
                'WARNING:sigil.addons.base.models.ir_actions.server_action_safe_eval:This is a test warning log',
                'ERROR:sigil.addons.base.models.ir_actions.server_action_safe_eval:This is a test error log',
"""ERROR:sigil.addons.base.models.ir_actions.server_action_safe_eval:This is a test exception log
...
ZeroDivisionError: division by zero""" % self.test_server_action.id
    ...
    @mute_logger('sigil.addons.base.models.ir_model', 'sigil.models')
    ...
    @mute_logger('sigil.addons.base.models.ir_actions')
    ...
    def test_90_webhook(self):
        ...
        with patch.object(requests, 'post', _patched_post), mute_logger('sigil.addons.base.models.ir_actions'):
            # first run: 200
            self.action.with_context(self.context).run()
...
class TestCustomFields(TestCommonCustomFields):
    def test_create_custom(self):
        ...
        with self.assertRaises(IntegrityError), mute_logger('sigil.sql_db'):
    ...
    @mute_logger('sigil.addons.base.models.ir_ui_view')
...
class TestCustomFieldsPostInstall(TestCommonCustomFields):
    ...
    def test_add_field_valid(self):
        ...
        with self.assertLogs('sigil.registry') as log_catcher:
