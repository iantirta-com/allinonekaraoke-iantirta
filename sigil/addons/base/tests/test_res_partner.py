...
from sigil import Command, models
from sigil.addons.base.models.ir_mail_server import extract_rfc2822_addresses
...
from sigil.exceptions import AccessError, RedirectWarning, UserError, ValidationError
from sigil.tests import Form
from sigil.tests.common import new_test_user, tagged, TransactionCase, users, warmup
...
class TestPartner(TransactionCaseWithUserDemo):
    ...
    def test_main_user_id(self):
        """Test main_user_id compute, including SigilBot special case and priority among several users."""
