...
from sigil import Command, fields, models
from sigil.exceptions import AccessError, MissingError, UserError, ValidationError
from sigil.fields import Domain
from sigil.tests import Form, TransactionCase, tagged, users
from sigil.tools import float_repr, mute_logger
from sigil.tools.image import image_data_uri
...
%endif"""
    ...
    @mute_logger('sigil.addons.base.models.ir_model')
    ...
    def test_85_binary_guess_zip(self):
        from sigil.addons.base.tests.test_mimetypes import ZIP  # noqa: PLC0415
    ...
    def test_86_text_base64_guess_svg(self):
        from sigil.addons.base.tests.test_mimetypes import SVG  # noqa: PLC0415
...
%endif"""
    ...
    @patch('sigil.orm.fields_textual.html_sanitize', return_value='<p>comment</p>')
...
class TestSelectionOndeleteAdvanced(TransactionCase):
    ...
    def test_ondelete_unexisting_policy(self):
        from sigil.orm.model_classes import add_to_registry  # noqa: PLC0415
...
class TestFieldParametersValidation(TransactionCase):
    def test_invalid_parameter(self):
        ...
        with self.assertLogs('sigil.fields', level='WARNING') as cm:
            self.registry._setup_models__(self.env.cr, [])  # incremental setup

        self.assertTrue(cm.output[0].startswith(
            "WARNING:sigil.fields:Field test_orm.field_parameter_validation.name: "
...
class TestUnlinkConstraints(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        from sigil.addons.base.models.ir_model import (  # noqa: PLC0415
