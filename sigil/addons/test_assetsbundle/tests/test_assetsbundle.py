...
import sigil.modules
from sigil import api
from sigil.addons.base.models.assetsbundle import AssetsBundle, XMLAssetError, ANY_UNIQUE
from sigil.addons.base.models.ir_asset import AssetPaths
from sigil.addons.base.models.ir_attachment import IrAttachment
from sigil.tests import HttpCase, tagged
...
class TestAddonPaths(TransactionCase):
    def test_operations(self):
        ...
        asset_paths.append([
            ('/home/user/sigil/addons/web/a', '/web/a', 1),
            ('/home/user/sigil/addons/web/c', '/web/c', 1),
            ('/home/user/sigil/addons/web/d', '/web/d', 1),
        ], 'bundle1')
        self.assertEqual(asset_paths.list, [
            ('/home/user/sigil/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/sigil/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/sigil/addons/web/d', '/web/d', 'bundle1', 1),
        ])

        # append with a duplicate of 'c'
        asset_paths.append([
            ('/home/user/sigil/addons/web/c', '/web/c', 1),
            ('/home/user/sigil/addons/web/f', '/web/f', 1),
        ], 'bundle2')
        self.assertEqual(asset_paths.list, [
            ('/home/user/sigil/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/sigil/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/sigil/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/sigil/addons/web/f', '/web/f', 'bundle2', 1),
        ])

        # insert with a duplicate of 'c' after 'c'
        asset_paths.insert([
            ('/home/user/sigil/addons/web/c', '/web/c', 1),
            ('/home/user/sigil/addons/web/e', '/web/e', 1),
        ], 'bundle3', 3)
        self.assertEqual(asset_paths.list, [
            ('/home/user/sigil/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/sigil/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/sigil/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/sigil/addons/web/e', '/web/e', 'bundle3', 1),
            ('/home/user/sigil/addons/web/f', '/web/f', 'bundle2', 1),
        ])

        # insert with a duplicate of 'd' before 'd'
        asset_paths.insert([
            ('/home/user/sigil/addons/web/b', '/web/b', 1),
            ('/home/user/sigil/addons/web/d', '/web/d', 1),
        ], 'bundle4', 1)
        self.assertEqual(asset_paths.list, [

            ('/home/user/sigil/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/sigil/addons/web/b', '/web/b', 'bundle4', 1),
            ('/home/user/sigil/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/sigil/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/sigil/addons/web/e', '/web/e', 'bundle3', 1),
            ('/home/user/sigil/addons/web/f', '/web/f', 'bundle2', 1),
        ...
        asset_paths.remove([
            ('/home/user/sigil/addons/web/c', '/web/c', 1),
            ('/home/user/sigil/addons/web/d', '/web/d', 1),
            ('/home/user/sigil/addons/web/g', '/web/g', 1),
        ], 'bundle5')
        self.assertEqual(asset_paths.list, [
            ('/home/user/sigil/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/sigil/addons/web/b', '/web/b', 'bundle4', 1),
...
class AddonManifestPatched(TransactionCase):
    def setUp(self):
        ...
        self.manifests = Manifests(sigil.modules.Manifest.for_addon)

        self.patch(self.env.registry, '_init_modules', self.installed_modules)
        self.patch(sigil.modules.Manifest, 'for_addon', lambda module, **kw: self.manifests[module])
...
class TestJavascriptAssetsBundle(FileTouchable):
    ...
    def test_15_rtl_invalid_css_generation(self):
        ...
        with mute_logger('sigil.addons.base.models.assetsbundle'):
            self.bundle.css()
...
<html>
    <head>
        ...
        <script type="text/javascript" src="{links[5]}" onerror="__sigilAssetError=1"></script>
    </head>
    <body>
    </body>
</html>"""))
...
<html>
    <head>
        ...
        <script type="text/javascript" src="http://test.external.link/javascript1.js"></script>
        <script type="text/javascript" src="http://test.external.link/javascript2.js"></script>
        <script type="text/javascript" src="/web/assets/debug/test_assetsbundle.bundle4.js" onerror="__sigilAssetError=1"></script>
    </head>
    <body>
    </body>
</html>"""))
...
class TestAssetsManifest(AddonManifestPatched):
    ...
    @mute_logger('sigil.addons.base.models.ir_asset')
    def test_31(self):
...
@tagged('-at_install', 'post_install')
@unittest.skipIf(os.getenv("SIGIL_FAKETIME_TEST_MODE"), "This test cannot work with faketime")
class TestErrorManagement(HttpCase):
    ...
    def test_assets_bundle_css_error_backend(self):
        ...
        with mute_logger('sigil.addons.base.models.assetsbundle'):
            self.start_tour('/sigil', 'css_error_tour', login='admin')
