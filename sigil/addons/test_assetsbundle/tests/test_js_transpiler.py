...
from sigil.tools.js_transpiler import transpile_javascript
...
class TestJsTranspiler(TransactionCase):
    ...
    def test_01_alias(self):
        input_content = """/** @sigil-module alias=test_assetsbundle.Alias **/"""
        result = transpile_javascript("/test_assetsbundle/static/src/alias.js", input_content)

        expected_result = """sigil.define('@test_assetsbundle/alias', [], function (require) {
'use strict';
let __exports = {};
/** @sigil-module alias=test_assetsbundle.Alias **/
return __exports;
});

sigil.define(`test_assetsbundle.Alias`, ['@test_assetsbundle/alias'], function (require) {
...
"""
    ...
    def test_02_default(self):
        input_content = """/** @sigil-module alias=test_assetsbundle.Alias default=False **/"""
        result = transpile_javascript("/test_assetsbundle/static/src/alias.js", input_content)

        expected_result = """sigil.define('@test_assetsbundle/alias', [], function (require) {
'use strict';
let __exports = {};
/** @sigil-module alias=test_assetsbundle.Alias default=False **/
return __exports;
});
...
"""
        ...
        input_content = """/** @sigil-module alias=test_assetsbundle.Alias default=0 **/"""
        result = transpile_javascript("/test_assetsbundle/static/src/alias.js", input_content)

        expected_result = """sigil.define('@test_assetsbundle/alias', [], function (require) {
'use strict';
let __exports = {};
/** @sigil-module alias=test_assetsbundle.Alias default=0 **/
return __exports;
});
...
"""
        ...
        expected_result = """sigil.define('@test_assetsbundle/classes', [], function (require) {
'use strict';
let __exports = {};
...
"""
        ...
        expected_result = """sigil.define('@test_assetsbundle/comments', [], function (require) {
'use strict';
let __exports = {};
/**
 * This is a comment
...
"""
        ...
        expected_result = """sigil.define('@test_assetsbundle/functions', [], function (require) {
'use strict';
let __exports = {};
...
"""
        ...
        expected_result = """sigil.define('@test_assetsbundle/import', ['@test_assetsbundle/Dialog', 'Dialog', '@tests/Dialog', 'test.Dialog', 'test.Dialog2', 'legacy.module', '@new_module/file', '@test.Dialog', 'test/Dialog', 'test.Dialog.error'], function (require) {
'use strict';
let __exports = {};
/**
 * import { Dialog, Notification } from "../src/Dialog";
...
import d from "@tests";"""
        ...
        expected_result = """sigil.define('@test_assetsbundle', ['@tests/dir', '@tests'], function (require) {
'use strict';
let __exports = {};
...
"""
        ...
        expected_result = """sigil.define('@test_assetsbundle/list', ['@tests/Dialog', '@test_assetsbundle/Dialog'], function (require) {
'use strict';
let __exports = {};
...
"""
        ...
        expected_result = """sigil.define('@test_assetsbundle/variables', [], function (require) {
'use strict';
let __exports = {};
...
"""
    ...
    def test_10_qunit_module_test(self):
        ...
        expected_result = """sigil.define('@test_assetsbundle/../tests/alias', [], function (require) {
'use strict';
let __exports = {};
...
"""
        ...
        expected_result = """sigil.define('@test_assetsbundle/alias', ['@test/Dialog', '@test/Dialog2'], function (require) {
'use strict';
let __exports = {};
...
"""
        ...
        expected_result = """sigil.define('@test_assetsbundle/a', ['@test_assetsbundle/some_file'], function (require) {
'use strict';
let __exports = {};
