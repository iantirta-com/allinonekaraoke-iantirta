...
from sigil.tools.misc import mute_logger
...
class TestError(common.HttpCase):
    def setUp(self):
        ...
        ml = mute_logger('sigil.addons.rpc.controllers.xmlrpc')
    ...
    def test_01_private(self):
        with self.assertRaisesRegex(Exception, r"Private method"), mute_logger('sigil.http'):
    ...
    def test_01_create(self):
        ...
        with self.assertRaises(Fault) as ctx, mute_logger("sigil.sql_db", "sigil.http"):
    ...
    def test_03_sql_constraint(self):
        with mute_logger("sigil.sql_db"), self.assertLogs("sigil.http", level="WARNING") as capture:
