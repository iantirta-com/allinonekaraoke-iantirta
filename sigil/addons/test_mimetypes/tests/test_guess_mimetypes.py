...
from sigil.tools.mimetypes import _sigil_guess_mimetype, guess_mimetype
...
class TestMimeGuessingSigil(BaseCase, MimeGuessingCases):
    guess_mimetype = staticmethod(_sigil_guess_mimetype)
...
@unittest.skipIf(guess_mimetype is _sigil_guess_mimetype, "python-magic not installed")
