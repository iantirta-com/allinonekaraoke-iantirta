from sigil.tests import common
...
class TestFillTemporal(common.TransactionCase):
    ...
    def test_timestamp_without_timezone(self):
        ...
        Date stored with an hour inside the Sigil model are processed as timestamp
    ...
    def test_with_datetimes_and_groupby_per_hour(self):
        ...
        expected = [{
            ...
            'datetime:hour': ('1916-01-01 13:00:00', '13:00 01 Jan'),
            '__count': 1,
            'value:sum': 5,
        }, {
            '__extra_domain': ['&',
            ...
            'datetime:hour': ('1916-01-01 14:00:00', '14:00 01 Jan'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__extra_domain': ['&',
            ...
            'datetime:hour': ('1916-01-01 15:00:00', '15:00 01 Jan'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__extra_domain': ['&',
            ...
            'datetime:hour': ('1916-01-01 16:00:00', '16:00 01 Jan'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__extra_domain': ['&',
            ...
            'datetime:hour': ('1916-01-01 17:00:00', '17:00 01 Jan'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__extra_domain': ['&',
            ...
            'datetime:hour': ('1916-01-01 18:00:00', '18:00 01 Jan'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__extra_domain': ['&',
            ...
            'datetime:hour': ('1916-01-01 19:00:00', '19:00 01 Jan'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__extra_domain': ['&',
            ...
            'datetime:hour': ('1916-01-01 20:00:00', '20:00 01 Jan'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__extra_domain': ['&',
            ...
            'datetime:hour': ('1916-01-01 21:00:00', '21:00 01 Jan'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__extra_domain': ['&',
            ...
            'datetime:hour': ('1916-01-01 22:00:00', '22:00 01 Jan'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__extra_domain': ['&',
            ...
            'datetime:hour': ('1916-01-01 23:00:00', '23:00 01 Jan'),
            '__count': 1,
            'value:sum': 7,
        }]
