...
from sigil.tools.misc import file_open, mute_logger, file_path
from sigil.tools.translate import TranslationModuleReader, TranslationRecordReader, code_translations, CodeTranslations, PYTHON_TRANSLATION_COMMENT, JAVASCRIPT_TRANSLATION_COMMENT, translation_file_reader
from sigil import Command
from sigil.addons.base.models.ir_fields import BOOLEAN_TRANSLATIONS
...
class TestImport(common.TransactionCase):
    ...
    def test_import_from_po_file(self):
        ...
        with mute_logger('sigil.addons.base.models.res_lang'):
...
class TestTranslationFlow(common.TransactionCase):
    ...
    def test_export_spreadsheet_new_dataset(self):
        ...
        self.assertEqual(set(terms), {
            ...
            'Scorecard title',
            'Opportunities',
            'Sigil Chart horizontal axis title',
            'Sigil Chart vertical axis title'
        })
