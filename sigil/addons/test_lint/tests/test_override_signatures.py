...
from sigil.tests.common import get_db_name, tagged
...
def get_sigil_module_name(python_module_name):
    if python_module_name.startswith('sigil.addons.'):
        return python_module_name.split('.')[2]
    if python_module_name == 'sigil.models':
        return 'sigil'
    ...
    def test_lint_override_signature(self):
        ...
        for model_name, model_cls in registry.items():
            ...
            for method_name, _ in inspect.getmembers(model_cls, inspect.isroutine):
                ...
                parent_module = get_sigil_module_name(parent_class.__module__)
                ...
                for child_class in reverse_mro:
                    ...
                    child_module = get_sigil_module_name(child_class.__module__)
        ...
        #with open('/tmp/sigil-override-signatures.md', 'w') as f:
